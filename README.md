...
> 详细的版本更新记录请查看 [版本更新记录文档](docs/使用文档/版本更新记录.md)
...
- **修复最近对话显示问题**
  - 修复了首页最近对话列表中可能显示别人角色的问题
  - 优化了查询条件，确保只获取当前用户的聊天记录
  - 添加了批量获取角色信息的逻辑，确保显示正确的角色名称和头像
  - 统一了角色信息字段，使用`role_id`、`role_name`和`role_avatar`作为标准字段
