...
本文档展示了HeartChat项目的数据库结构，包括各个集合的字段和关系。为了提高可读性，数据库结构图被拆分为多个图表展示。
...
graph TD
    ...
    classDef indexNode fill:#bbf,stroke:#333,stroke-width:2px;
    class UI1,UI2,UI3,UBI1,UBI2,UPI1,UII1,UII2 indexNode;
```
...
graph TD
    ...
    classDef indexNode fill:#bfb,stroke:#333,stroke-width:2px;
    class RI1,RI2,RI3,RI4,RI5,CI1,CI2,CI3,CI4,MI1,MI2,MI3,MI4 indexNode;
```
...
graph TD
    ...
    class EI1,EI2,EI3,EI4,EI5,URI1,URI2,URI3,URI4 indexNode;
```
